...
# A file creating a multilayer CNN to process the mnist dataset and recognize digits
...
for i, (p, e) in enumerate(zip(predictions, y_test)):
    predicted, expected = np.argmax(p), np.argmax(e)  # getting actual predicted and expected
    if predicted != expected:
        incorrect_predictions.append((i, images[i], predicted, expected))
print("number of incorrect: ", len(incorrect_predictions))  # looking at all incorrect
