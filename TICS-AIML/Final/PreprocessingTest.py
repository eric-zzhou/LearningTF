...
for i in range(len(cnts)):
    ...
    if chars:
        ...
        if curr[1][0] + curr[1][2] + edge_buffer > x:
            ...
            # print(f"{(x, y, w, h)} + {temp} = ")
            # print(f"\t{x + w}, {temp[0] + temp[2]}")
            # print(f"\t{y + h}, {temp[1] + temp[3]}")
